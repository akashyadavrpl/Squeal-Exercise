/* NOTE: We are not creator of this database. 
A big thanks and shoutout to
https://github.com/AndrejPHP
for sharing this. We are using this only for educational purpose
MILD modifications are done, just for this course purpose
 */
...
CREATE DATABASE IF NOT EXISTS `lco_git_share` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `lco_git_share`;
--
--
